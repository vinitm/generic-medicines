...
var Typeahead = Marionette.ItemView.extend({
	...
	onShow: function() {
		...
		var self = this;
		this.$el.typeahead({ hint: true, highlight: true }, { limit: Infinity, displayKey: 'suggestion', name: 'suggestions', source: engine, templates: { empty: require('./empty_typeahead.tpl') } })
